...
def generate_stock_ledger_pdf(stock_df, target_supplier, upto_date_str):
  ...
  table_data = [[
      ...
      Paragraph("Up-to Date", header_style),
  ]]
  ...
  for _, row in stock_df.iterrows():
    table_data.append([
        ...
        Paragraph(str(upto_date_str), cell_style),
    ])

  t = Table(table_data, colWidths=[35, 230, 85, 80, 90, 85])
  t.setStyle(
      TableStyle([
          ("BACKGROUND", (0, 0), (-1, 0), colors.HexColor("#1f2937")),
          ("ALIGN", (0, 0), (-1, -1), "CENTER"),
          ...
          if not filtered_stock_df.empty:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "Up-to Date": st.column_config.TextColumn(
